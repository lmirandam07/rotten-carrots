...
public class ContactoProceso {
    ...
    public ContactoProceso(){
        ...
        try{
            ...
            this.conn = DriverManager.getConnection("jdbc:mariadb://localhost:3306/rotten-carrots", "root", "lionel");
    ...
    public int GuardarContacto(Contacto contacto){
        ...
        try{
            ...
            String query = "INSERT INTO contacto(asunto, consulta)";
                    /* cadena concatenada para poner los VALUES que se van a insertar */
                   query += "VALUES('"+contacto.getAsunto()+"','"+contacto.getConsulta()+"')";

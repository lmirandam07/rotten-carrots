...
INSERT INTO spoiler (id_usuario, id_pelicula, titulo_spoiler, genero, descripcion_spoiler) VALUES
('1', '2', 'El discurso de Rosie en la boda de Alex','Romance', 'Prácticamente confesó que Alex era el amor de su vida ahí merengues, en frente de todos, el día que este men se estaba casando... con Bethany Williams.'),
('1', '3', 'Andy consigue el trabajo que queria', 'Comedia', 'Alfinal de la pelicula Miranda la recomiendad y asi obtiene el trabajo'),
('2','2', 'Rosie y Alex terminan juntos', 'Romance', 'La verdad no hay mucho que comentar al respecto, es como dice el titulo');
